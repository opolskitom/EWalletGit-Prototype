            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.reportAction:
                        Intent report = new Intent(AccountsActivity.this, ReportActivity.class);
                        finish();
                    ...
                    case R.id.notificationsAction:
                        Intent notifications = new Intent(AccountsActivity.this, NotificationsActivity.class);
                        finish();
                    ...
                    case R.id.settingsAction:
                        Intent settings = new Intent(AccountsActivity.this, SettingsActivity.class);
                        finish();
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch(menuItem.getItemId()) {
                    case R.id.dm_profile:
                        Intent profile = new Intent(AccountsActivity.this, ProfileActivity.class);
                        finish();
                    ...
                    case R.id.dm_help:
                        Intent help = new Intent(AccountsActivity.this, HelpActivity.class);
                        finish();
                    ...
                    case R.id.dm_logout:
                        Intent logout = new Intent(AccountsActivity.this, StartingActivity.class);
